...
public abstract partial class SharedGunSystem
{
    ...
    {
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, ComponentStartup>(OnChamberStartup);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, TakeAmmoEvent>(OnChamberMagazineTakeAmmo);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, GetAmmoCountEvent>(OnChamberAmmoCount);
        ...
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, GetVerbsEvent<ActivationVerb>>(OnChamberActivationVerb);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, GetVerbsEvent<InteractionVerb>>(OnChamberInteractionVerb);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, GetVerbsEvent<AlternativeVerb>>(OnMagazineVerb);

        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, ActivateInWorldEvent>(OnChamberActivate);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, UseInHandEvent>(OnChamberUse);

        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, EntInsertedIntoContainerMessage>(OnMagazineSlotChange);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, EntRemovedFromContainerMessage>(OnMagazineSlotChange);
        SubscribeLocalEvent<ChamberClipAmmoProviderComponent, ExaminedEvent>(OnChamberMagazineExamine);
    }

    private void OnChamberStartup(EntityUid uid, ChamberClipAmmoProviderComponent component, ComponentStartup args)
    {
    ...
    /// </summary>
    private void OnChamberActivate(EntityUid uid, ChamberClipAmmoProviderComponent component, ActivateInWorldEvent args)
    {
        if (args.Handled)
            return;
    ...
    /// </summary>
    private void OnChamberUse(EntityUid uid, ChamberClipAmmoProviderComponent component, UseInHandEvent args)
    {
        if (args.Handled)
            return;
    ...
    /// </summary>
    private void OnChamberActivationVerb(EntityUid uid, ChamberClipAmmoProviderComponent component, GetVerbsEvent<ActivationVerb> args)
    {
    ...
    /// </summary>
    private void UseChambered(EntityUid uid, ChamberClipAmmoProviderComponent component, EntityUid? user = null)
    {
    ...
    /// </summary>
    private void OnChamberInteractionVerb(EntityUid uid, ChamberClipAmmoProviderComponent component, GetVerbsEvent<InteractionVerb> args)
    {
        if (!args.CanAccess || !args.CanInteract || component.BoltClosed == null)
            return;
    ...
    /// </summary>
    public void SetBoltClosed(EntityUid uid, ChamberClipAmmoProviderComponent component, bool value, EntityUid? user = null, AppearanceComponent? appearance = null, ItemSlotsComponent? slots = null)
    {
    ...
    /// <summary>
    /// Tries to take ammo from the clip and insert into the chamber.
    /// </summary>
    private void CycleCartridge(EntityUid uid, ChamberClipAmmoProviderComponent component, EntityUid? user = null, AppearanceComponent? appearance = null)
    {
    ...
    /// </summary>
    public void ToggleBolt(EntityUid uid, ChamberClipAmmoProviderComponent component, EntityUid? user = null)
    {
        if (component.BoltClosed == null)
            return;
    ...
    /// </summary>
    private void OnChamberMagazineExamine(EntityUid uid, ChamberClipAmmoProviderComponent component, ExaminedEvent args)
    {
        ...
        using (args.PushGroup(nameof(ChamberClipAmmoProviderComponent)))
        {
            if (component.BoltClosed != null)
            {
    ...
    protected (int, int) GetChamberMagazineCountCapacity(EntityUid uid, ChamberClipAmmoProviderComponent component)
    {
    ...
    private void OnChamberAmmoCount(EntityUid uid, ChamberClipAmmoProviderComponent component, ref GetAmmoCountEvent args)
    {
    ...
    private void OnChamberMagazineTakeAmmo(EntityUid uid, ChamberClipAmmoProviderComponent component, TakeAmmoEvent args)
    {
        if (component.BoltClosed == false)
        {
